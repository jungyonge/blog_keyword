...
public class KeywordStat {
    ...
    //쿠팡 상품명 스텟구하기
    public Map getCoupangDealStat(String dealName){
        ...
        try {
            ...
            map = getCoupangDealStatHttp(hmacSHA256,timestamp,baseUrl+"/keywordstool",apiKey,customerId,query,keyword,"make");
    ...
    public Map getCoupangDealStatHttp(String hmacSHA256, String timestamp, String requestURL, String apikey, long customerId, String query, String keyword, String make) {
